...
function setTipsData() {
    ...
    if (inputValue.value.length > 0) {
        ...
        cardUtil.searchCardField(props.cardTypeName, props.cardFieldName, inputValue.value).then(data => {
        ...
        cardUtil.latestCardField(props.cardTypeName, props.cardFieldName).then(data => {
